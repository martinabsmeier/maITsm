...
/**
 * Represents a state in a {@link StateMachine}. Normally you wouldn't create instances of this class directly but rather use the
 * {@link de.ma.it.common.sm.annotation.State} annotation to define your states and then let {@link StateMachineFactory} create a
 * {@link StateMachine} for you.
 * <p>
 * {@link State}s inherits {@link Transition}s from their parent. A {@link State} can override any of the parents {@link Transition}s. When
 * an {@link Event} is processed the {@link Transition}s of the current {@link State} will be searched for a {@link Transition} which can
 * handle the event. If none is found the {@link State}'s parent will be searched and so on.
 * </p>
 * 
...
public class State {
	 ...
	 *            the {@link SelfTransition} to add.
	...
	/**
	 * Adds an outgoing {@link Transition} to this {@link State} with the specified weight. The higher the weight the less important a
	 * {@link Transition} is. If two {@link Transition}s match the same {@link Event} the {@link Transition} with the lower weight will be
	 * executed.
	 * 
	 * @param transition
	 *            the {@link Transition} to add.
