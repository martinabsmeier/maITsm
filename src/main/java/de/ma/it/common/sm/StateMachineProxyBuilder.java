...
import de.ma.it.common.sm.context.SingletonStateContextLookup;
import de.ma.it.common.sm.context.StateContext;
import de.ma.it.common.sm.context.StateContextLookup;
import de.ma.it.common.sm.event.DefaultEventFactory;
import de.ma.it.common.sm.event.Event;
import de.ma.it.common.sm.event.EventArgumentsInterceptor;
...
public class StateMachineProxyBuilder {
	 ...
	 * 
	 * @param contextLookup
	 *            the {@link StateContextLookup} to use.
	 * @return this {@link StateMachineProxyBuilder} for method chaining.
	 */
	 ...
	 * 
	 * @param interceptor
	 *            the {@link EventArgumentsInterceptor} to use.
	 * @return this {@link StateMachineProxyBuilder} for method chaining.
	 */
	 ...
	 * 
	 * @param b
	 *            <code>true</code> to ignore context lookup failures.
	 * @return this {@link StateMachineProxyBuilder} for method chaining.
	 */
	 ...
	 * @param sm
	 *            the {@link StateMachine} which will receive the events generated by the method calls on the proxy.
	...
	public Object create(Class<?>[] ifaces, StateMachine sm) {
		...
		InvocationHandler handler = new MethodInvocationHandler(sm, contextLookup, interceptor, eventFactory, ignoreUnhandledEvents,
				ignoreStateContextLookupFailure, name);
	...
	private static class MethodInvocationHandler implements InvocationHandler {
		...
		public MethodInvocationHandler(StateMachine sm, StateContextLookup contextLookup, EventArgumentsInterceptor interceptor,
				EventFactory eventFactory, boolean ignoreUnhandledEvents, boolean ignoreStateContextLookupFailure, String name) {
			this.contextLookup = contextLookup;
			this.sm = sm;
			this.interceptor = interceptor;
			this.eventFactory = eventFactory;
